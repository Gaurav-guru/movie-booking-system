...
const MovieList = ({ searchText }) => {
  ...
  const ACCESS_TOKEN = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzMWI1OGM2ODY5NDMyNDhiZjZkOTg2YmUwM2RjNTE1MiIsIm5iZiI6MTcyMDY3MzYxNS43MzcyMDEsInN1YiI6IjY2OGY1ZDgyOGNlMjQwZGNlNjEwZWZhMSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Qyrr0vUwC3Jav9AYej-3wxGkNnezYYQ_3TJWvIoOJlA';
  ...
  return (
    <div className='container px-4 py-4 mx-auto'>
      ...
      <h1 className='mb-4 font-bold text-left'>All Movies</h1>
